	...
	<div class="table-responsive">
		<table>
			...
			<tbody>
                        ...
                        $selectquery = "SELECT c.courier_id,q.price,cu.cu_name,r.r_name,cu.cu_address,r.r_address,cu.cu_phone_no,r.r_phone_no,cu.cu_email_id,r.r_email_id,cu.pickup_date,r.delivery_date,q.f_pincode,q.t_pincode,q.delivery_service,q.weight,c.height,c.length,c.courier_time

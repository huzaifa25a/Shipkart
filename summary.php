<?php
$con = mysqli_connect("localhost","root","","Shipkart");
...
$sql_2 = "SELECT c.courier_id, q.f_pincode, q.t_pincode, q.weight, c.height, c.length, q.delivery_service, cu.pickup_date, r.delivery_date FROM courier as c,quote as q,reciever as r,customer as cu WHERE c.courier_id = cu.courier_id AND c.courier_id = r.courier_id AND c.quote_id = cu.quote_id AND q.quote_id = c.quote_id AND q.quote_id = cu.quote_id ORDER BY courier_id desc LIMIT 1";
  ...
  <div class="bg">
    <div class="nav">
        ...
        <ul>
            ...
            <div class="dropdown">
                <li style="float:right"><a href="mlogin.html">Login</a></li>
            </div>
        </ul>
    </div>
    </div>
